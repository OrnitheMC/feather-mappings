...
![Build](https://img.shields.io/github/workflow/status/Copetan/feather-mappings/Build/1.7.2?label=Build) ![Publish](https://img.shields.io/github/workflow/status/Copetan/feather-mappings/Publish/1.7.2?label=Publish)
